...
class Nutritionist(models.Model):
    ...
    city = models.CharField(
        max_length=20,help_text="e.g. Lahore, Gujrat, Islamabad"
    )

    experience_years = models.PositiveIntegerField(default=1)
    rating = models.DecimalField(
        max_digits=2,decimal_places=1,default=3.5
    )

    timing = models.CharField(
        max_length=50,help_text="e.g. 1:00 PM – 3:00 PM"
    )
    ...
    image = models.ImageField(
        upload_to="nutritionists/",null=True,blank=True
    )
